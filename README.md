...
<h4>
<a href="https://github.com/DOligex/LicorneBibliotheque" target="blank">APP repository</a>
</h4>



<h4> Reminders about this node-template </h4>
...
Works by the same way than <strong>Node Javascript</strong> but enforce linting.
...
Works by the same way than <strong>Node Typescript</strong> but enforce linting.
`npm run lint`: Verify syntaxe error and code quality 
